...
方式1：通过 ghp.ci 代理脚本
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) 704e2e8e6bb01e694363daafb363cb05
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 704e2e8e6bb01e694363daafb363cb05
```
方式3：手动下载二进制文件
...
cursor-vip 704e2e8e6bb01e694363daafb363cb05;
# Windows
